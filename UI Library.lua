...
local library = utility.table({theme = table.clone(themes.Artemis), folder = "Artemis", extension = "cfg", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "Artemis"}
...
function library:Load(options)
	...
	local name = "Artemis [BETA]"
	local sizeX = options.sizex or 450
	local sizeY = options.sizey or 500
	local theme = options.theme and options.theme or "Artemis"
